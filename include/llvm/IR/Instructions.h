...
public:
  static GetElementPtrInst *Create(Value *Ptr, ArrayRef<Value *> IdxList,
    ...
    return new(Values) GetElementPtrInst(Ptr, IdxList, Values, NameStr, InsertBefore);
  }
  static GetElementPtrInst *Create(Value *Ptr, ArrayRef<Value *> IdxList,
                                   const Twine &NameStr,
                                   BasicBlock *InsertAtEnd) {
    unsigned Values = 1 + unsigned(IdxList.size());
    return new(Values) GetElementPtrInst(Ptr, IdxList, Values, NameStr, InsertAtEnd);
  }


//add function Create(NULL,)
static GetElementPtrInst *Create(Type *PointeeType,Value *Ptr, ArrayRef<Value *> IdxList,
                                   const Twine &NameStr,
                                   BasicBlock *InsertAtEnd) {
    unsigned Values = 1 + unsigned(IdxList.size());
    return new(Values) GetElementPtrInst(Ptr, IdxList, Values, NameStr, InsertAtEnd);
...
//***************************************beging*********************************
  ...
  //         PointeeType ==
  //         cast<PointerType>(Ptr->getType()->getScalarType())->getElementType());
  //   return new (Values) GetElementPtrInst(PointeeType, Ptr, IdxList, Values,NameStr, InsertBefore);
  // }
  // static GetElementPtrInst *Create(Type *PointeeType, Value *Ptr,
  //                                  ArrayRef<Value *> IdxList,
  //                                  const Twine &NameStr,
  ...
  //         PointeeType ==
  //         cast<PointerType>(Ptr->getType()->getScalarType())->getElementType());
  //   return new (Values) GetElementPtrInst(PointeeType, Ptr, IdxList, Values,NameStr, InsertAtEnd);
  // }
